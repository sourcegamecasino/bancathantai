!(function() {
  ...
  function P(t) {
    var e = new O(t);
    M.simulateStateBeforeDeferScriptsActivation(), e.harvestDeferScriptsInDocument(), new W(
      e,
      {
        nonce: t,
        blocking: !1,
  ...
  var A = "http://www.w3.org/2000/svg",
    ...
    C = (function() {
      ...
      return (t.prototype.enable = function(t) {
        var e = this;
        (this.insertionPointMarker = t), (this.buffer =
        ...
        (document.write = L), (document.writeln = _), this.buffer.length &&
        ...
        (e.innerHTML = this.buffer), this.scriptStack.harvestScriptsAfterDocWrite(
          e
    ...
    j = (function() {
      function t() {
        var t = this;
        (this.simulatedReadyState =
          "loading"), (this.bypassEventsInProxies = !1), (this.nativeWindowAddEventListener =
      ...
      return (t.prototype.runOnLoad = function(t) {
        ...
        this.proxyInlineHandler(
          document,
          "onreadystatechange"
        ), this.proxyInlineHandler(window, "onload"), document.body &&
          this.proxyInlineHandler(document.body, "onload");
      }), (t.prototype.simulateStateBeforeDeferScriptsActivation = function() {
        (this.bypassEventsInProxies = !0), (this.simulatedReadyState =
          "interactive"), l(
          document,
          "readystatechange"
        ...
        var t = this;
        (this.bypassEventsInProxies = !0), l(
          document,
          "DOMContentLoaded"
        ), (this.simulatedReadyState = "complete"), l(
          document,
          "readystatechange"
        ), l(
          window,
          "load"
        ), (this.bypassEventsInProxies = !1), window.setTimeout(function() {
    ...
    W = (function() {
      ...
      return (t.prototype.insertPreloadHints = function() {
        ...
        this.scriptStack.forEach(function(e) {
          if (a(e, t.settings.nonce)) {
            ...
            if (n && !r) {
              ...
              o.setAttribute("rel", "preload"), o.setAttribute(
                "as",
                "script"
              ), o.setAttribute("href", n), e.crossOrigin &&
                o.setAttribute(
                  "crossorigin",
                  e.crossOrigin
                ), document.head.appendChild(o), t.preloadHints.push(o);
            }
          }
        });
        ...
        this.settings.docWriteSimulator &&
          !t.async &&
          this.settings.docWriteSimulator.flushWrittenContentAndDisable(), M.updateInlineHandlers(), o(
          t.placeholder
        );
